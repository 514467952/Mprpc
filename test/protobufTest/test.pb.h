...
class GetFriendListsResponse_HashEntry_DoNotUse;
class GetFriendListsResponse_HashEntry_DoNotUseDefaultTypeInternal;
extern GetFriendListsResponse_HashEntry_DoNotUseDefaultTypeInternal _GetFriendListsResponse_HashEntry_DoNotUse_default_instance_;
class LoginRequest;
...
template<> ::fixbug::GetFriendListsResponse_HashEntry_DoNotUse* Arena::CreateMaybeMessage<::fixbug::GetFriendListsResponse_HashEntry_DoNotUse>(Arena*);
...
class GetFriendListsResponse_HashEntry_DoNotUse : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<GetFriendListsResponse_HashEntry_DoNotUse, 
    ::PROTOBUF_NAMESPACE_ID::int32, std::string,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    0 > {
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<GetFriendListsResponse_HashEntry_DoNotUse, 
    ::PROTOBUF_NAMESPACE_ID::int32, std::string,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    0 > SuperType;
  GetFriendListsResponse_HashEntry_DoNotUse();
  GetFriendListsResponse_HashEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  void MergeFrom(const GetFriendListsResponse_HashEntry_DoNotUse& other);
  static const GetFriendListsResponse_HashEntry_DoNotUse* internal_default_instance() { return reinterpret_cast<const GetFriendListsResponse_HashEntry_DoNotUse*>(&_GetFriendListsResponse_HashEntry_DoNotUse_default_instance_); }
  static bool ValidateKey(void*) { return true; }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "fixbug.GetFriendListsResponse.HashEntry.value");
 }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_test_2eproto);
    return ::descriptor_table_test_2eproto.file_level_metadata[5];
  }
...
class UserServicRpc_Stub;

class UserServicRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
  // This class should be treated as an abstract interface.
  inline UserServicRpc() {};
 public:
  virtual ~UserServicRpc();

  typedef UserServicRpc_Stub Stub;
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserServicRpc);
};

class UserServicRpc_Stub : public UserServicRpc {
 public:
  UserServicRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  UserServicRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(UserServicRpc_Stub);
};
...
// map<int32, string> hash = 3;
inline int GetFriendListsResponse::_internal_hash_size() const {
  return hash_.size();
}
inline int GetFriendListsResponse::hash_size() const {
  return _internal_hash_size();
}
inline void GetFriendListsResponse::clear_hash() {
  hash_.Clear();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, std::string >&
GetFriendListsResponse::_internal_hash() const {
  return hash_.GetMap();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, std::string >&
GetFriendListsResponse::hash() const {
  // @@protoc_insertion_point(field_map:fixbug.GetFriendListsResponse.hash)
  return _internal_hash();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, std::string >*
GetFriendListsResponse::_internal_mutable_hash() {
  return hash_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, std::string >*
GetFriendListsResponse::mutable_hash() {
  // @@protoc_insertion_point(field_mutable_map:fixbug.GetFriendListsResponse.hash)
